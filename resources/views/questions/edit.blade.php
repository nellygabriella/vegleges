                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>{!!Html::linkRoute('questions.show', 'Mégse', array($question->id),array('class'=>'btn btn-primary btn-fw'))!!}</td>
...
<script type="text/javascript">
    ...
    $('.select2-multi').select2().val({!! json_encode($question->tags()->allRelatedIds())!!}).trigger('change');
</script>
