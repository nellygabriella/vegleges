@extends('page')
<?php $titleTag = htmlspecialchars($project->title); ?>
...
<div class="news">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="sidebar">
						<div class="button button_color_1 <a href="{{route('projects.create')}}" class="button button_color_1 text-center trans_200" role="button">Új projekt</a>
					<!-- Archives -->
